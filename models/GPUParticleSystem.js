...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
	...
	this.spawnParticle = function(options) {
		...
		self.posStart.array[i * 4 + 0] = position.x + rnd2()// ((particleSystem.random()) * positionRandomness); // - ( velocity.x * particleSystem.random() ); //x
		self.posStart.array[i * 4 + 1] = position.y + rnd2()// ((particleSystem.random()) * positionRandomness); // - ( velocity.y * particleSystem.random() ); //y
		self.posStart.array[i * 4 + 2] = position.z + rnd2()//((particleSystem.random()) * positionRandomness); // - ( velocity.z * particleSystem.random() ); //z
