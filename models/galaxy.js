...
function generateGalaxy(){
	...
	var galacticTexture0 = textureLoader.load( "images/galactic_sharp.png" );
	var galacticTexture1 = textureLoader.load( "images/galactic_blur.png" );
	...
	var galacticShaderMaterial = new THREE.PointsMaterial( {
		size: 1000, sizeAttenuation: true, map: sprite, alphaTest: 0.1, transparent: true
	});
	...
	pGalacticSystem = new THREE.Points( pGalaxy, galacticShaderMaterial );
	...
	var galacticTopMaterial = new THREE.MeshBasicMaterial({
		map: textureLoader.load('images/galactictop.png'),
	...
	plane.position.z = -200000;
	plane.position.y= 115470
	...
	*/
	pGalacticSystem.scale.set(10, 10, 10)
	pGalacticSystem.rotation.x = Math.PI/6;
	pGalacticSystem.position.z= -200000
	pGalacticSystem.position.y= 115470
	pGalacticSystem.updateMatrix();
}
function GalaxyRotate(){
	galRotDegree += galRotSpeed;
	pGalacticSystem.rotation.y = galRotDegree;
	plane.rotation.z = -galRotDegree;
}